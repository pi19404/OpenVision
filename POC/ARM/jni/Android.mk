...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    LOCAL_CFLAGS +=  -DHAVE_NEON=1 -ftree-vectorize  -mfpu=neon -O3 -mfloat-abi=softfp -ffast-math 
    LOCAL_CPPFLAGS +=  -DHAVE_NEON=1 -ftree-vectorize  -mfpu=neon -O3 -mfloat-abi=softfp -ffast-math
